...
<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
  ...
  <?php if ( function_exists('core_pagination') ) { core_pagination(); } else if ( is_paged() ) { ?>
  <ul class="pagination">
    <li class="page-item older">
      <?php next_posts_link('<i class="fas fa-arrow-left"></i> ' . __('Previous', 'core')) ?></li>
    <li class="page-item newer">
      <?php previous_posts_link(__('Next', 'core') . ' <i class="fas fa-arrow-right"></i>') ?></li>
  </ul>
  <?php } ?>
