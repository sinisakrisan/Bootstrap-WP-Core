...
if ( ! function_exists('core_setup') ) {
	function core_setup() {
		...
		// core cannot support extra-wide blocks
...
add_action('init', 'core_setup');

if ( ! function_exists( 'core_avatar_attributes' ) ) {
	function core_avatar_attributes($avatar_attributes) {
...
add_filter('get_avatar','core_avatar_attributes');

if ( ! function_exists( 'core_author_avatar' ) ) {
	function core_author_avatar() {

		echo get_avatar('', $size = '96');
	}
}

if ( ! function_exists( 'core_author_description' ) ) {
	function core_author_description() {
		echo get_the_author_meta('user_description');
	}
}

if ( ! function_exists( 'core_post_date' ) ) {
	function core_post_date() {
